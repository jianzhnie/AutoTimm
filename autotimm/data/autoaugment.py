...
class SubPolicy(object):
    ...
    def __init__(self, p1, method1, magnitude_idx1, p2, method2,
                 magnitude_idx2):
        operation_factory = OperationFactory()
        self.p1 = p1
        self.p2 = p2
        self.operation1 = operation_factory.get_operation(
            method1, magnitude_idx1)
        self.operation2 = operation_factory.get_operation(
            method2, magnitude_idx2)
...
class OperationFactory:
    ...
    def __init__(self):
        ...
        self.operations = {
            ...
            'solarizeadd':
            lambda img, magnitude: solarize_add(img, magnitude),
            'contrast':
            ...
            lambda img, magnitude: ImageEnhance.Brightness(img).enhance(
                magnitude),
            'autocontrast':
            lambda img, _: ImageOps.autocontrast(img),
            'equalize':
            lambda img, _: ImageOps.equalize(img),
            'invert':
            lambda img, _: ImageOps.invert(img)
        }
